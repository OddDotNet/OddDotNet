...
public class SpanUInt32QueryTests : IClassFixture<AspireFixture>, IAsyncLifetime
{
    ...
    [Theory]
    [InlineData(1u, 1u, NumberCompareAsType.Equals, WherePropertyFilter.ValueOneofCase.LinkFlags, true)]
    [InlineData(0u, 1u, NumberCompareAsType.Equals, WherePropertyFilter.ValueOneofCase.LinkFlags, false)]
    [InlineData(0u, 1u, NumberCompareAsType.NotEquals, WherePropertyFilter.ValueOneofCase.LinkFlags, true)]
    [InlineData(1u, 1u, NumberCompareAsType.NotEquals, WherePropertyFilter.ValueOneofCase.LinkFlags, false)]
    [InlineData(1u, 1u, NumberCompareAsType.GreaterThanEquals, WherePropertyFilter.ValueOneofCase.LinkFlags,
        true)]
    [InlineData(1u, 2u, NumberCompareAsType.GreaterThanEquals, WherePropertyFilter.ValueOneofCase.LinkFlags,
        true)]
    [InlineData(2u, 1u, NumberCompareAsType.GreaterThanEquals, WherePropertyFilter.ValueOneofCase.LinkFlags,
        false)]
